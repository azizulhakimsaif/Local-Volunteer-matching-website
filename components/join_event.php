...
if (isset($data['event_id']) && isset($_SESSION['user_id'])) {
    ...
    try {
        ...
        //     echo json_encode(['success' => true, 'error' => 'This event has reached its maximum number of volunteers. '+ $capacityData["participant_count"]]);
        //     // echo json_encode(['success' => false, 'error' => 'This event has reached its maximum number of volunteers. '+ $capacityData["participant_count"]]);
        //     exit;
        // }
        ...
        echo json_encode(['success' => true,'data'=>$capacityData['participant_count'] ]);
    } catch (Exception $e) {
